...
const IdealGasSceneRefactor: React.FC<Props> = (props: Props) => {
  ...
  const connectWs = () => {
    if (ws === null) {
      ...
      console.log(ws)
      const socket = new WebSocket('ws://192.168.0.6:8000/simulate/ideal_gas_system?simulator_id=1000');
      // setWs(socket);
      ws = socket;
...
export default IdealGasSceneRefactor;
